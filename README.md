...
* http://c9.4.0.local:2013/c-app/rest/plugin-b/1/info ( :white_check_mark: Works)
...
* http://c9.4.0.local:2013/c-app/rest/plugin-a/1/magic/2 Injecting a component by interface:
  * MyInterface is injected in the constructor of the REST API,
  * REST API answers "Component A" ( :white_check_mark: Works)
* http://c9.4.0.local:2013/c-app/rest/plugin-a/1/magic/3 Using the PluginAccessor ( :x: Doesn't work):
  * The REST API uses `pluginAccessor.getEnabledModulesByClass(ComponentA.class)`,
  * It should return "Component A" ( :x: Doesn't work),
* http://c9.4.0.local:2013/c-app/rest/plugin-a/1/magic/4 Using the PluginAccessor for an interface ( :x: Doesn't work):
...
* But it returns neither of them at http://c9.4.0.local:2013/c-app/rest/plugin-a/1/magic/4 ( :x: Doesn't work)